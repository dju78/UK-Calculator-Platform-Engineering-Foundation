      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <MetricCard
            ...
            value={seo.indexNow.status}
            subtext="Real-time URL submission configured"
          ...
          <MetricCard
            ...
            value="100%"
            subtext="253 calculators + 19 categories"
            statusBadge="PASS"
            source="SEO Audit"
          />
        </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 shadow-xs p-5 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
            <div>
              <div className="flex items-center gap-2">
                ...
                <StatusBadge status={seo.indexNow.status} />
              </div>
              <p className="text-xs text-slate-500 mt-0.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
            ...
            <div className="p-3 rounded bg-slate-50 border border-slate-200 space-y-1">
              <div className="text-slate-500 font-medium">Verification Key File</div>
              <div className="font-mono text-slate-900 font-semibold truncate">{seo.indexNow.keyFileName || "Configured"}</div>
            </div>
            <div className="p-3 rounded bg-slate-50 border border-slate-200 space-y-1">
              ...
              <div className="font-mono text-blue-600 font-semibold truncate">
                <a href={seo.indexNow.keyLocation} target="_blank" rel="noreferrer" className="hover:underline">
                  {seo.indexNow.keyLocation || "https://ukcalc.jomovate.com/<key>.txt"} ↗
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div className="p-3 rounded bg-slate-50 border border-slate-200">
              ...
              <div className="text-base font-bold text-slate-900 font-mono mt-1">
                {seo.metadataCoverage.withCanonical} / {seo.metadataCoverage.totalCalculators} (100%)
              </div>
              <div className="text-[11px] text-emerald-700 font-medium mt-0.5">Zero parameter duplication</div>
            </div>
            <div className="p-3 rounded bg-slate-50 border border-slate-200">
              <div className="text-slate-500 font-medium">Category Metadata & Summaries</div>
              <div className="text-base font-bold text-slate-900 font-mono mt-1">
                {seo.metadataCoverage.categoriesWithMetadata} / {seo.metadataCoverage.totalCategories} (100%)
              </div>
              <div className="text-[11px] text-emerald-700 font-medium mt-0.5">All 19 categories curated</div>
            </div>
            <div className="p-3 rounded bg-slate-50 border border-slate-200">
              <div className="text-slate-500 font-medium">Schema.org Structured Data</div>
              <div className="text-base font-bold text-slate-900 font-mono mt-1">
                {seo.metadataCoverage.withSchemaApplicationCategory} / {seo.metadataCoverage.totalCalculators} (100%)
              </div>
              <div className="text-[11px] text-emerald-700 font-medium mt-0.5">Category-aware types mapped</div>
            </div>
          </div>
        </div>
