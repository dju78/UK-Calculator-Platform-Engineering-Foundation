    ...
    <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-10 shadow-2xs">
      <div className="prose max-w-none">
        ...
        <p>
          ...
          <Link href="/editorial-policy" className="text-slate-900 underline hover:text-slate-950">
            Editorial Policy
          </Link>{" "}
          and{" "}
          <Link href="/how-we-check-our-figures" className="text-slate-900 underline hover:text-slate-950">
