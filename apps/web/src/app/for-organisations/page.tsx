    ...
    <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-10 shadow-2xs">
      <div className="prose max-w-none">
        ...
        <div className="not-prose my-6">
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-slate-900 text-white font-medium text-sm hover:bg-slate-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 transition-colors shadow-2xs cursor-pointer"
          >
            Contact Our Team
          </Link>
        </div>
